...
Snapshot of @elirobinson/react@2.0.1 and @elirobinson/tokens@0.5.0,
generated by @elirobinson/ai-patterns@0.9.2.
...
- `llms.txt` — the index: every component and hook with its one-line description and
  import path. Start here; it is 44 components and 7 hooks.
